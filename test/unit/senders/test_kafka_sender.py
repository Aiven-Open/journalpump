...
class TestKafkaSenderInit:
    ...
    def test_initialization_with_message_key(self) -> None:
    ...
    def test_initialization_with_max_send_interval(self) -> None:
    ...
    def test_initialization_default_max_send_interval(self) -> None:
...
class TestGenerateClientConfig:
    ...
    def test_basic_client_config(self) -> None:
    ...
    def test_client_config_with_explicit_security_protocol_ssl(self) -> None:
    ...
    def test_client_config_with_sasl_plaintext(self) -> None:
    ...
    def test_client_config_with_sasl_ssl(self) -> None:
    ...
    def test_client_config_sasl_default_mechanism(self) -> None:
    ...
    def test_client_config_sasl_missing_username(self) -> None:
    ...
    def test_client_config_sasl_missing_password(self) -> None:
...
class TestGenerateProducerConfig:
    ...
    def test_producer_config_inherits_client_config(self) -> None:
    ...
    def test_producer_config_sets_linger_ms(self) -> None:
    ...
    def test_producer_config_compression_gzip_default(self) -> None:
    ...
    def test_producer_config_with_socks5_proxy(self) -> None:
    ...
    def test_producer_config_without_socks5_proxy(self) -> None:
...
class TestValidSecurityProtocols:
    ...
    def test_valid_security_protocols(self, protocol: str) -> None:
