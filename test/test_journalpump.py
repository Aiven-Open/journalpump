...
class TestUnitLogLevels(TestCase):
    def test_empty(self):
        log_level = "INFO"
        ll = UnitLogLevel("test", {"unit-a": log_level})
    ...
    def test_no_systemd_unit(self):
        ll = UnitLogLevel("test", {"unit-a": "CRITICAL"})
...
class TestJournalObjectHandler(TestCase):
    def setUp(self):
        ...
        self.unit_log_levels_d = UnitLogLevel("unit_log_levels_d", {"test-unit": self.priority_d})
